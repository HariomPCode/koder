...
See `backend/services/contest.service.js`, `backend/tests/contest/test_contest_engine.js`, and `docs/phases/phase-05/CONTEST_ENGINE.md`.
...
**Authoritative document:** `docs/phases/phase-06/SCORING_ENGINE.md`
...
- Tests: `backend/tests/contracts/test_scoring_contract.js`, `backend/tests/scoring/test_scoring_models.js`, `backend/tests/scoring/test_scoring_engine.js`
...
| Contract tests | `backend/tests/contracts/test_scoring_contract.js` |
| Model tests | `backend/tests/scoring/test_scoring_models.js` |
| Integration tests | `backend/tests/scoring/test_scoring_engine.js` |
...
> `docs/phases/phase-07/REDIS_LEADERBOARD.md`: MongoDB `ContestParticipant` is authoritative;
...
ICPC-style (solved count primary, penalty time tiebreak) — **decided in Phase 6 review** (`docs/phases/phase-06/SCORING_ENGINE.md`). MongoDB authoritative scoring uses ACM/ICPC penalty semantics; `Contest.problems[].points` is retained but not used for Phase 6 ranking. Phase 7 Redis is only a projection of `ContestParticipant`; it must preserve `solvedCount DESC`, `totalPenalty ASC`, `lastAcceptedContestMs ASC`, and `userId ASC` without introducing a second scoring model.
...
Use the provisional Phase 7 projection breakdown in `docs/phases/phase-07/REDIS_LEADERBOARD.md`
instead.
