...
async function runTests() {
  ...
  try {
    ...
    await testCase("13. promoteAdmin.js rejects missing and invalid email arguments", async () => {
      try {
        execSync("node promoteAdmin.js", { stdio: "pipe", cwd: path.resolve(__dirname, "../../") });
      ...
      try {
        execSync("node promoteAdmin.js invalid-email-format", { stdio: "pipe", cwd: path.resolve(__dirname, "../../") });
